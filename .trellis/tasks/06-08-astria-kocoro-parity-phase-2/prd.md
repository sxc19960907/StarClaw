...
| P1 | `06-08-run-quality-scorecard` | Add a Run Quality scorecard for completion quality, evidence strength, budget posture, retry risk, reuse readiness, and delivery readiness. |
