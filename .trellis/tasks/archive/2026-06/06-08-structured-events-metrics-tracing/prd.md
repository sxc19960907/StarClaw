...
- [x] Structured event schema is documented and test-covered.
- [x] Runtime emits events for run start/end/error and budget/fallback decisions where implemented.
- [x] Metrics endpoint/export returns stable counters without secrets.
- [x] Existing event stream and Web UI smoke tests continue to pass.
- [x] Tests cover redaction and metric shape.
